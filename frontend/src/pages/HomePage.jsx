      ...
      <Card title="Acciones Rápidas">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary-500 hover:bg-primary-50 transition-all text-left"
          >
            <FileText className="w-8 h-8 text-primary-600 mb-3" />
            <h3 className="font-semibold text-gray-900 mb-1">Nueva Matriz</h3>
          ...
          {hasLexdataAccess && (
            <button
              ...
              className="p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all text-left"
            >
              <FileEdit className="w-8 h-8 text-purple-600 mb-3" />
              <h3 className="font-semibold text-gray-900 mb-1">Nueva Minuta</h3>
              <p className="text-sm text-gray-600">Generar minuta notarial</p>
            </button>
          )}
        </div>
      </Card>
